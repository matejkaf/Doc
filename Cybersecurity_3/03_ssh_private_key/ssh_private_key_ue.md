...
Als zusätzliche Sicherheitsmaßnahme kann der private key mit einem Passwort (passphrase) verschlüsselt werden. In diesem Fall muss bei jedem Remote Einloggen dieses Passwort angegeben werden.
